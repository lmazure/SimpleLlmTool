...
/**
 * MessageRound represents a round of message exchange.
 */
record MessageRound(Role role, String content, List<ToolCall> toolCalls, String tool, String toolCallId) {
    ...
    /**
     * Role represents the actor (i.e. the source) of a message.
    ...
    /**
     * ToolCall represents a tool call in a round of message exchange
     */
    record ToolCall(String toolName, String toolCallId, List<ToolParameter> toolParameters) {
    }

    /**
     * ToolParameter represents a parameter in a tool call in a round of message exchange
     */
