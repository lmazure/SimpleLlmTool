 ...
 */
public class GoogleGeminiModelParameters extends ModelParameters {
    ...
    public GoogleGeminiModelParameters(final String modelName,
    ...
    /**
     * Load parameters from a YAML file and create a new GeminiModelParameters instance.
     *
     ...
     * @return a new GeminiModelParameters instance with the parameters from the YAML file
     ...
     */
    public static GoogleGeminiModelParameters loadFromFile(final Path yamlFilePath,
        ...
        try (final InputStream inputStream = new FileInputStream(yamlFilePath.toFile())) {
            ...
            return new GoogleGeminiModelParameters(overridingModelName.orElse(parameterMap.getString("modelName")),
